				...
				<div class="NavBarWraper">
					...
					<div class="NavBarButtonIconContainer">
						<button class="NavBarButtonIcon" onclick="ToggleDropDown()">
							...
							<img
								src="./images/icons/openNav.svg"
								alt="O"
								class="openNav active"
							/>
						</button>
					</div>
				</div>
		...
		<main>
			<section class="StartContainer" id="Start">
				...
				<img
					...
					alt="Imagem qeu contém referência a cultura maker"
				/>
			</section>
			...
			<section class="TeamContainer" id="Team">
				...
				<section class="TeamCardContainer">
					...
					<div class="cardTeam">
						...
						<img
							src="./images/TeamImages/Vinicius.jpg"
							alt="Vinicius da Silva"
						/>
						<a href="https://www.linkedin.com/" target="_blank">
							<img src="./images/icons/linkedin.svg" alt="linkedin" />
						</a>
			...
			<section class="ContactContainer" id="Contact">
				<div>
					...
					<div class="ContactIconsContainer">
						<a
							href="https://www.instagram.com/espacomakermuzambinho/"
						...
						<a
							href="mailto:espaco.maker@muz.ifsuldeminas.edu.br"
							rel="noopener noreferrer"
						>
